...
export const HOSTED_MODEL_PROVIDERS: HostedModelProvider[] = [
  ...
  { key: 'openserv', name: 'OpenServ', description: 'Current SERV reasoning-wrapped models for agent workflows.' },
...
export const HOSTED_MODELS: HostedModelOption[] = [
  ...
  },
  {
    ...
    priceLabel: '$1 input / $6 output per 1M tokens',
  },
  {
    ...
    priceLabel: '$2.50 input / $15 output per 1M tokens',
  },
  {
    ...
    priceLabel: '$5 input / $30 output per 1M tokens',
  ...
  {
    id: 'openserv/deepseek-v4-flash',
    name: 'DeepSeek V4 Flash + SERV',
    providerKey: 'openserv',
    provider: 'OpenServ',
    category: 'Fast',
    cost: 'Low',
    context: '128K',
    description: 'Current low-cost DeepSeek V4 Flash wrapped with SERV reasoning.',
    priceLabel: '$0.18 input / $0.35 output per 1M tokens',
  },
  {
    id: 'openserv/deepseek-v4-pro',
    name: 'DeepSeek V4 Pro + SERV',
    providerKey: 'openserv',
    provider: 'OpenServ',
    category: 'Advanced',
    cost: 'Low',
    context: '128K',
    description: 'Current DeepSeek V4 Pro wrapped with SERV reasoning for complex agent tasks.',
    priceLabel: '$0.55 input / $1.10 output per 1M tokens',
  },
  {
  ...
  },
  {
    ...
    priceLabel: '$2 input / $10 output per 1M tokens',
  },
  {
    ...
    priceLabel: '$10 input / $50 output per 1M tokens',
  ...
  },
  {
    ...
    priceLabel: '$1.50 input / $9 output per 1M tokens',
  },
  {
  ...
  },
  {
    ...
    priceLabel: '$0.32 input / $1.28 output per 1M tokens',
  },
  {
    id: 'qwen/qwen3-max',
    name: 'Qwen3 Max',
  ...
  },
  {
    ...
    priceLabel: '$0.42 input / $1.32 output per 1M tokens',
  },
  {
