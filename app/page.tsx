...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0B1A] text-white overflow-x-hidden">
      ...
      {/* ── FOOTER ─────────────────────────────────────── */}
      <footer className="border-t border-white/[0.06] py-12 sm:py-16 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-lg font-bold text-white" style={{ fontFamily: 'var(--font-display), system-ui, sans-serif' }}>Hatcher</span>
              </div>
              <p className="text-sm text-[#A5A1C2] leading-relaxed max-w-xs">
                Deploy autonomous AI agents across 20+ platforms. Powered by OpenClaw, secured by Solana.
              </p>
            </div>

            {/* Product */}
            <div>
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#71717a] mb-4">Product</p>
            ...
            {/* Resources */}
            <div>
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#71717a] mb-4">Resources</p>
              <ul className="space-y-2.5">
                {[
            ...
            {/* Community */}
            <div>
              <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#71717a] mb-4">Community</p>
              <ul className="space-y-2.5">
                {[
                  { label: 'Twitter', href: 'https://twitter.com/HatcherLabs' },
                  { label: 'Discord', href: 'https://discord.gg/hatcher' },
                  { label: 'GitHub', href: 'https://github.com/HatcherLabs' },
                  { label: 'Telegram', href: 'https://t.me/hatcherlabs' },
                ].map((link) => (
                  <li key={link.href}>
                    <a
                      href={link.href}
          ...
          <div className="pt-8 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-[#71717a]">
              &copy; {new Date().getFullYear()} HatcherLabs. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              <span className="text-xs text-[#71717a]">Powered by</span>
              <span className="text-xs font-medium text-[#A5A1C2]">OpenClaw</span>
              <span className="text-xs text-[#71717a]">&middot;</span>
              <span className="text-xs font-medium text-[#A5A1C2]">Solana</span>
            </div>
          </div>
        </div>
      </footer>
