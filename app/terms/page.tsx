        ...
        <div className="prose-custom space-y-10 text-[var(--text-secondary)] text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              SOL, USDC, $HATCHER, $KAUSA, $ANSEM (on-chain), or by credit/debit card via Stripe. Crypto amounts are calculated at
          ...
          <section>
            ...
            <p className="mt-3">
              <strong className="text-[var(--text-primary)]">On-chain payments (SOL/USDC/$HATCHER/$KAUSA/$ANSEM)</strong> are
