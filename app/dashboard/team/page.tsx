      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <motion.div variants={itemVariants} className={cardClass + ' p-6'}>
              ...
              {team.members
                ...
                .map((member) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-white/[0.06] flex items-center justify-center text-xs font-bold text-white">
                      ...
                      <div className="flex items-center gap-2">
                        {isAdmin && member.role !== 'owner' && !isSelf && (
                          <div className="relative">
                            ...
                            <ChevronDown className="w-3 h-3 text-[#71717a] absolute right-1.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                          </div>
                        )}
            ...
            {isAdmin && (
              <div className="mt-5 pt-4 border-t border-white/[0.06]">
                <h4 className="text-xs font-semibold text-[#A5A1C2] mb-3 flex items-center gap-1.5">
          ...
          <motion.div variants={itemVariants} className={cardClass + ' p-6'}>
            ...
            {teamAgents.length === 0 ? (
              <p className="text-sm text-[#71717a] py-4 text-center">No agents shared with this team yet.</p>
            ) : (
              <div className="space-y-2 mb-4">
                {teamAgents.map((agent) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] uppercase tracking-wider text-[#71717a] font-medium">{agent.framework}</span>
                      {isAdmin && (
                        <button
