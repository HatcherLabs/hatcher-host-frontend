...
export const metadata: Metadata = {
  ...
  description:
    'Create a free Hatcher account and deploy your first AI agent in minutes. No credit card required. Free tier includes AI Credits and access to all platforms.',
