export type ComputeNetworkMetricId =
  "active-nodes" | "available-vram" | "jobs-24h" | "provider-payouts";
...
export type ComputeNetworkMetricValues = Partial<
  Record<ComputeNetworkMetricId, string | number>
>;
...
export type ExecutionModeId =
  "single-node" | "distributed-tasks" | "model-sharded-mesh";
...
export type DeviceClassId =
  "cpu-integrated" | "vram-4-8" | "vram-12-24" | "multi-gpu";
