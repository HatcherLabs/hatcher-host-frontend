  ...
  return (
    <div className="rounded-xl border border-white/[0.06] bg-[#0D0B1A] overflow-hidden">
      <div className="flex items-center justify-between border-b border-white/[0.06] px-1">
        ...
        <button
          onClick={handleCopy}
          className="mr-2 p-1.5 rounded-lg text-[#6B6890] hover:text-[#f97316] hover:bg-[#f97316]/10 transition-all duration-200"
...
function MethodBadge({ method }: { method: string }) {
  const colors: Record<string, string> = {
    ...
    POST: 'bg-[#f97316]/15 text-[#f97316] border-[#f97316]/25',
        ...
        {open && (
          ...
          >
            <div className="px-4 pb-4 space-y-4">
              <div className="w-full h-px bg-gradient-to-r from-transparent via-[rgba(249,115,22,0.2)] to-transparent" />
...
const RATE_LIMIT_TIERS = [
  ...
  { tier: 'Pro', requests: '10,000', price: '$15/mo' },
  { tier: 'Business', requests: '100,000', price: '$45/mo' },
];
        ...
        <motion.div variants={cardVariants} className="mb-10">
          <div className="card glass-noise p-6">
            ...
            <p className="text-sm text-[#A5A1C2] mb-4 leading-relaxed">
              ...
              the <code className="px-1.5 py-0.5 rounded bg-[#252240] text-[#f97316] font-[family-name:var(--font-mono)] text-xs">Authorization</code> header
              as a Bearer token.
            </p>
            ...
            <div className="rounded-lg border border-white/[0.06] bg-[#0D0B1A] p-4 mb-4">
              <code className="text-sm font-[family-name:var(--font-mono)] text-[#A5A1C2]">
                Authorization: Bearer <span className="text-[#f97316]">hk_your_api_key</span>
              </code>
            </div>

            <p className="text-sm text-[#A5A1C2] mb-4 leading-relaxed">
              You can find and regenerate your API key on the{' '}
              <Link href="/settings" className="text-[#f97316] hover:underline underline-offset-2 decoration-[#f97316]/30">
                Settings page
              </Link>
              . Keys are prefixed with <code className="px-1.5 py-0.5 rounded bg-[#252240] text-[#f97316] font-[family-name:var(--font-mono)] text-xs">hk_</code> for easy identification.
            </p>
            ...
            <div className="space-y-1.5">
              {[
                ...
                <div key={h.header} className="flex items-center gap-3 text-sm">
                  <code className="px-2 py-0.5 rounded bg-[#252240] text-[#f97316] font-[family-name:var(--font-mono)] text-xs flex-shrink-0">
                    {h.header}
                  </code>
                ...
                <tbody>
                  {ERROR_CODES.map((err, i) => (
                    <tr key={err.code} className={cn('border-b border-white/[0.04] transition-colors hover:bg-white/[0.02]', i === ERROR_CODES.length - 1 && 'border-b-0')}>
                      <td className="px-4 py-3 font-[family-name:var(--font-mono)] text-xs text-[#f97316]">{err.code}</td>
                      <td className="px-4 py-3">
                        <span className={cn(
                          ...
                          err.http === '400' ? 'bg-[#f97316]/15 text-[#f97316] border-[#f97316]/25' :
