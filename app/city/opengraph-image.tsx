    ...
    (
      <div
        style={{
          ...
          padding: '72px',
          background:
            'radial-gradient(circle at 20% 15%, rgba(168,85,247,0.28), transparent 50%), radial-gradient(circle at 80% 85%, rgba(56,189,248,0.22), transparent 50%), #050814',
          color: '#e5e7eb',
      ...
      >
        ...
        <div
          style={{
            ...
            color: '#ffffff',
            letterSpacing: -2,
            textShadow: '0 0 36px rgba(251,191,36,0.28)',
          }}
        >
          Every AI agent.
          <br />
        ...
        >
          {total.toLocaleString()} agents across 25 districts · {running} running right now ·
          built on four frameworks.
        </div>
