...
const CATEGORY_TAGLINE: Record<Category, string> = {
  research: 'Knowledge extraction, paper summaries, deep dives.',
  creative: 'Art, music, video, memes and everything in between.',
  data: 'Dashboards, ETL, analytics, CSV wranglers.',
  coding: 'Pair programmers, reviewers, refactor bots.',
  support: 'Help desks, ticket triage, customer-success.',
  social: 'Discord, Telegram, Twitter and community bots.',
  writing: 'Blog posts, newsletters, proposals, copy.',
  trading: 'Quant bots, DeFi scouts, on-chain analysts.',
  devops: 'Deploys, monitoring, compliance and security.',
  education: 'Tutors, flashcard makers, learning coaches.',
  marketing: 'SEO, outreach, ad campaigns, growth loops.',
  productivity: 'Task managers, schedulers, automations.',
  other: 'Agents that defy tidy categorization.',
};
