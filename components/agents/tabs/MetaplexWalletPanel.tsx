    ...
    <GlassCard className="p-5">
      ...
      {registeredAsset && (
        <div className="mt-4 rounded-md border border-[var(--color-success-border)] bg-[var(--color-success-bg)] p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="min-w-0">
              <div className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--color-success)]">Registered identity</div>
              <a
                href={metaplexAssetUrl(registeredAsset)}
                target="_blank"
                rel="noreferrer"
            ...
            {result?.txHash && (
              <a
                href={metaplexTxUrl(result.txHash)}
                target="_blank"
                rel="noreferrer"
