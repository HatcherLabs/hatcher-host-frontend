    ...
    expect(parts).toEqual([
      ...
      { kind: 'markdown', content: '\n' },
      {
        ...
        artifact: {
          ...
          downloadUrl: 'https://example.com/raw.csv',
        },
      },
    ]);
  });
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          ...
          url: 'http://localhost:3001/agents/agent_123/container-files/media?path=%2Ftmp%2Frobot_egg.png',
          downloadUrl: 'http://localhost:3001/agents/agent_123/container-files/media?path=%2Ftmp%2Frobot_egg.png&download=1',
  ...
  it('rewrites relative generated image filenames to authenticated workspace media URLs', () => {
    ...
    expect(parts).toEqual([
      { kind: 'markdown', content: 'Here it is:\n' },
      {
        ...
        artifact: {
          alt: 'Hatcher Robot',
          url: 'http://localhost:3001/agents/agent_123/container-files/media?path=hatcher_robot.png',
          downloadUrl: 'http://localhost:3001/agents/agent_123/container-files/media?path=hatcher_robot.png&download=1',
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          ...
          url: 'http://localhost:3001/agents/agent_123/container-files/media?path=generated%2Fdemo.mp4',
          downloadUrl: 'http://localhost:3001/agents/agent_123/container-files/media?path=generated%2Fdemo.mp4&download=1',
          filename: 'demo.mp4',
          mediaType: 'video/mp4',
        },
      },
      {
        ...
        artifact: {
          title: 'voiceover.mp3',
          url: 'http://localhost:3001/agents/agent_123/container-files/media?path=voiceover.mp3',
          downloadUrl: 'http://localhost:3001/agents/agent_123/container-files/media?path=voiceover.mp3&download=1',
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          title: 'Theme sound',
          url: 'http://localhost:3001/agents/agent_123/container-files/media?path=%2Ftmp%2Ftheme.wav',
          downloadUrl: 'http://localhost:3001/agents/agent_123/container-files/media?path=%2Ftmp%2Ftheme.wav&download=1',
          filename: 'theme.wav',
          mediaType: 'audio/wav',
        },
      },
    ...
    expect(parts).toEqual([
      ...
      { kind: 'markdown', content: '\n' },
      {
        ...
        artifact: {
          ...
          downloadUrl: 'https://cdn.example.com/narration.mp3',
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          ...
          downloadUrl: 'https://assets.example.com/logo.png',
          filename: 'logo.png',
          mediaType: 'image/png',
        },
      },
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          ...
          downloadUrl: 'https://v3.fal.media/files/penguin/demo.mp4',
          filename: 'demo.mp4',
          mediaType: 'video/mp4',
        },
      },
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          ...
          url: 'http://localhost:3001/agents/agent_123/media/video?jobId=job-123&index=0',
          downloadUrl: 'http://localhost:3001/agents/agent_123/media/video?jobId=job-123&index=0&download=1',
    ...
    expect(parts).toEqual([
      {
        ...
        artifact: {
          title: 'Generated video',
          url: 'http://localhost:3001/agents/agent_123/media/video?jobId=job-456&index=1',
          downloadUrl: 'http://localhost:3001/agents/agent_123/media/video?jobId=job-456&index=1&download=1',
    ...
    expect(parts).toEqual([
      { kind: 'markdown', content: 'Logo:\n' },
      {
        ...
        artifact: {
          ...
          filename: 'solana.png',
          downloadUrl: 'https://assets.coingecko.com/coins/images/4128/standard/solana.png',
          mediaType: 'image/png',
        },
      },
    ]);
