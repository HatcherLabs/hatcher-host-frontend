...
/**
 * MiladyRecentErrorsCard — surfaces ERROR/WARN lines from
 * Milady container stdout logs (docker logs). Parsed server-side,
...
export function MiladyRecentErrorsCard() {
  ...
  const fetchErrors = useCallback(async () => {
    ...
    try {
      const res = await api.getMiladyErrors(agent.id);
      if (res.success) {
