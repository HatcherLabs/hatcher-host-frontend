...
export type Tab = 'overview' | 'config' | 'integrations' | 'skills' | 'files' | 'logs' | 'terminal' | 'memory' | 'knowledge' | 'schedules' | 'workflows' | 'chat' | 'stats' | 'versions' | 'usage' | 'analytics' | 'health' | 'comm';
