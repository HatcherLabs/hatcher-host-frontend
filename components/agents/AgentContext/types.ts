...
export type Tab = 'overview' | 'config' | 'integrations' | 'skills' | 'plugins' | 'files' | 'logs' | 'terminal' | 'memory' | 'sessions' | 'knowledge' | 'schedules' | 'workflows' | 'chat' | 'mail' | 'stats' | 'wallet' | 'spawn' | 'kausalayer';
